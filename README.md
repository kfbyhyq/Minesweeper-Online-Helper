...
11. 观测3BV/s：在任意游戏页面生效，点击后可以关闭插件弹出页，会在游戏进行时或播放录像时生成每秒的bvs变化曲线

12. 观测效率：在任意游戏页面生效，点击后可以关闭插件弹出页，会在游戏进行时或播放录像时显示实时3BV和效率估计值，估计3BV为实际3BV的上限，总3BV估计不太准，仅供参考，越到后期越接近真实值，点击次数为有效点击，不包括误触或取消标雷等操作，估计效率为实际效率的上限；并生成每次有效点击的实时估计效率变化曲线

13. 刷新活动门票价格：只在活动门票月生效，在网站**市场**页采集所有活动竞技场门票的最低市场价

14. 刷新友谊任务：只在友谊任务月生效，在网站**活动任务**页采集**发送任务**、**收到的任务**、**已发送的任务**各自当前页中的任务信息，提取多页需要翻页后再次点击

15. 刷新友谊任务列表：只在友谊任务月生效，在网站**活动任务**页采集**发送任务**、**收到的任务**、**已发送的任务**所有页中的任务信息

16. 分析转盘选项：只在命运任务月生效，在**任务**页网址后加"/uid"打开的页面生效，uid为**我的主页**网址最后的数字，根据已有活动任务分析后续转盘可能的选项

17. 分析活动任务：只在全球任务月生效，在网站**活动任务**页根据近期任务分析下一个任务的信息

18. 统计奖牌榜：只在全球任务月生效，在网站**活动任务**页统计当前已有任务的前五名数据
...
5. 活动商店
    ...
    点击完美线最后一行第一列单元格可以输入自己设定的活动物品目标，按“Enter”保存，按“Esc”或点击页面其他位置退出
...
9. 命运任务
    ...
    只在命运任务月可用，根据已有活动任务分析后续转盘可能的选项

    - 分析转盘选项：前台打开**任务**页网址后加"/uid"的页面提取任务信息并自动关闭，效果等同插件弹出页的**分析转盘选项**
...
10. 全球任务
    ...
    - 分析活动任务：后台打开**活动任务**页分析任务信息并自动关闭，效果等同插件弹出页的**分析活动任务**

    - 打开活动任务页：打开网站**活动任务**页

    - 奖牌榜：在活动任务页通过插件弹出页“统计奖牌榜”更新
...
12. 设置
    ...
    设置网站主题、账号uid、估价相关参数、自动刷新、竞技场用时系数、备份数据和恢复备份
